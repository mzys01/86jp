...
namespace DfoServer.Game.Names
{
    ...
    {
        // df_game_r rejects restrict_inputting_name / hasSpecialCharacter with 0x9F.
        public const byte InvalidNameErrorCode = 0x9F;

        private static readonly UTF8Encoding StrictUtf8 = new UTF8Encoding(false, true);

        // Shared entry for user-entered names: character create/rename, guild names,
        // and creature rename should all pass their raw UTF-8 bytes through here.
